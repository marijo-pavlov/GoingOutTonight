...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = _react2.default.createClass({
		...
		updateAuth: function updateAuth(loggedIn) {
			var username = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
		...
		componentDidMount: function componentDidMount() {
			...
			if (this.state.query) {
				_superagent2.default.post('/api/searchplaces').send({
		...
		searchPlaces: function searchPlaces(event) {
			event.preventDefault();
			var query = (0, _reactDom.findDOMNode)(this.refs.query).value;
			var self = this;
		...
		toggleGoing: function toggleGoing(place) {
			var self = this;

			_superagent2.default.post('/api/togglegoing').send({
				place: place,
		...
		eachPlace: function eachPlace(place, i) {
			return _react2.default.createElement(
				'div',
				{ className: 'col-md-6 col-xs-12', key: i },
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-xs-4' },
						_react2.default.createElement('img', { src: place.image_url, alt: place.name })
					),
					_react2.default.createElement(
						'div',
						{ className: 'col-xs-8' },
						_react2.default.createElement(
							...
							this.state.loggedIn ? _react2.default.createElement(
								'button',
								{ className: 'btn btn-info pull-right', onClick: this.toggleGoing.bind(null, place) },
								place.goings,
								' Going'
							) : _react2.default.createElement(
								'a',
								{ href: '/api/auth/twitter', className: 'btn btn-info pull-right' },
								place.goings,
								' Going'
							)
						),
			...
			return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'h1',
								null,
								'Hello to GoingOutTonight!'
							),
							_react2.default.createElement(
								'p',
								null,
								'GoingOutTonight is a service for checking out great places.'
							)
						)
					)
				),
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'form',
							{ onSubmit: this.searchPlaces, id: 'searchPlacesForm' },
							_react2.default.createElement(
								'div',
								...
								_react2.default.createElement(
									'label',
									null,
									'In what city are you currently?'
								),
								_react2.default.createElement('input', { ref: 'query', type: 'text', className: 'form-control', placeholder: 'Where are you?', defaultValue: this.state.query, required: true }),
								_react2.default.createElement('span', { className: 'glyphicon glyphicon-search form-control-feedback searchIcon', 'aria-hidden': 'true' })
							),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  login: function login(username, pass, cb) {
	    ...
	    loginRequest(username, pass, function (res) {
	      if (res.authenticated) {
	        localStorage.token = res.token;
	        localStorage.username = res.username;
	        if (cb) cb(true);
	        _this.onChange(true, username);
	      } else {
	        if (cb) cb(false);
	...
	function loginRequest(username, password, cb) {
	  _superagent2.default.get('/api/login').end(function (err, res) {
	    if (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.field = function(name, val) {
	  if (!this._formData) {
	    var FormData = __webpack_require__(223); // browserify compatible. May throw if FormData is not supported natively.
